...
var LoginSceen = (function (_super) {
    ...
    LoginSceen.prototype.createElements = function () {
        return __awaiter(this, void 0, void 0, function () {
            var code, userInfo, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, app.platform.login()];
                    case 1:
                        code = (_a.sent()).code;
                        return [4 /*yield*/, app.platform.getUserInfo()];
                    case 2:
                        userInfo = (_a.sent()).userInfo;
    ...
    LoginSceen.prototype.createLogin = function () {
        var button = app.platform.createUserInfoButton({
            type: 'text',
            text: '获取用户信息111',
            style: {
                left: 10,
